...
local setup = once(function()
  ...
  local actions = {
    swap_up = make_repeatable("treewalker_swap_up", treewalker.swap_up),
    swap_right = make_repeatable("treewalker_swap_right", treewalker.swap_right),
    swap_down = make_repeatable("treewalker_swap_down", treewalker.swap_down),
    swap_left = make_repeatable("treewalker_swap_left", treewalker.swap_left),
  }
  return actions
end)
